...
public partial class TacticalPathManager
{
    ...
    private void InitSquadBar()
    {
        ...
        canonCountEl.style.position = Position.Absolute;
        canonCountEl.style.bottom = 2;
        canonCountEl.style.right = 4;
        canonCountEl.style.color = Color.white;
        canonCountEl.style.fontSize = 12;
        canonCountEl.style.unityFontStyleAndWeight = FontStyle.Bold;
